...
운동선수에서 개발자로 전환해 9년 경령을 쌓으며 백엔드 개발과 스타트업 개발자로서의 다양한 경험이 있습니다. Java, Spring, PostgreSQL, Git, Linux, Hadoop, Zookeeper, Hbase, Openlayers, Olcesium, Cesium, Geoserver 등을 사용하면서 설계, 개발, 운영한 경험이 있습니다.
적극적이며 원활한 커뮤니케이션으로 문제를 해결하기 위해 노력하며 새로운 기술 도입에 주저하지 않는 도전하는 개발자입니다.
...
* 해남군 해남e 한눈에! 스마트 군정시스템 구축(빅데이터)
    ...
    - 담당 역할 : 개발PM, 설계(기능정의,화면설계,DB설계), 데이터 수집 프로그램인  데이터 허브 웹 개발(공공데이터 포털,ITS,기상청,생활안전지도 등), HadoopEcoSystem 구축 ,빅데이터 수집 프로그램 개발(키워드 관련 뉴스기사 전체 데이터 수집)  해남군 해남e 스마트 군정시스템 웹 개발(전체)
